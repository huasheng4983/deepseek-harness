...
export const zh = {
  ...
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.uploadToWorkspace': '上传到工作区',
  'input.uploaded': '已上传 {n} 个文件到工作区',
  'input.upload.remove': '移除待发送文件（文件仍保留在工作区）',
  'input.upload.removed': '已从待发送移除（文件仍在工作区）',
  'input.uploadRejected.title': '文件过大',
  'input.uploadRejected.message': '单文件不能超过 {max}，以下文件未上传：',
  'input.uploadRejected.ok': '知道了',
  'input.uploadRejected.close': '关闭',
...
export const en = {
  ...
  'input.uploadToWorkspace': 'Upload to workspace',
  'input.uploaded': 'Uploaded {n} file(s) to workspace',
  'input.upload.remove': 'Remove pending file (file stays in workspace)',
  'input.upload.removed': 'Removed from pending (file stays in workspace)',
  'input.uploadRejected.title': 'File too large',
  'input.uploadRejected.message': 'Each file must be under {max}; these were not uploaded:',
  'input.uploadRejected.ok': 'Got it',
  'input.uploadRejected.close': 'Close',
